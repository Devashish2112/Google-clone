...
const Header: React.FC = () => {
    ...
    return (
        ...
        <Link href="https://mail.google.com" className="hover:underline text-sm cursor-pointer">Gmail</Link>
        <Link href="https://images.google.com" className="hover:underline text-sm cursor-pointer">Images</Link>
